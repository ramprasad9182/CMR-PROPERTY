...
class PurchaseBlankets(models.Model):
    ...
    #     ('draft', 'Draft'),
    #     ('pre_ongoing', 'Pre-Ongoing'),  # New state before 'ongoing'
    #     ('ongoing', 'Ongoing'),
    #     ('confirmed', 'Confirmed'),
    #     ('open', 'Bid Selection'),
    #     ('done', 'Closed'),
    #     ('cancel', 'Cancelled'),
    # ], string="Blanket Order State", default='draft')
    ...
    #
    # def button(self):
    #     res =self.env['purchase.requisition']._fields['state'].selection
    #     data = self.env['purchase.requisition']._fields['state_blanket_order'].selection
    #     print(res)
    #     print(data)
...
class PurchaseRequisitionLine(models.Model):
    ...
    # @api.constrains('is_price_changed_in_line')
    # def change_states(self):
    #     for rec in self:
    #         if rec.is_price_changed_in_line:
    #             state == 'pre_ongoing'
