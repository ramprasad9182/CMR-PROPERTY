...
class CategoryBill(models.Model):
    ...
    # ten = fields.Many2one('res.partner', string='Tenant', domain=[('user_type', '=', 'customer')])
    ...
    def create(self, vals):
        ...
        # if not record.ct_line_ids:
        #     record._onchange_months()
        return record
    ...
    # @api.constrains('ct_line_ids')
    # def _onchange_ct_line_ids(self):
    #     """
    #     Automatically set open_unit of each line as previous line's close_unit
    #     """
    #     for rec in self:
    #         prev_close = rec.ct_line_ids[0].open_unit if rec.ct_line_ids else 0
    #
    #         for line in rec.ct_line_ids:
    #             line.open_unit = prev_close
    #             prev_close = line.close_unit
    #             line.close_unit = prev_close
...
class DGReading(models.Model):
    ...
    # @api.constrains('dg_line_ids')
    # def _set_opening_units(self):
    #     for rec in self:
    #         if rec.dg_line_ids:
    #             prev_close = rec.dg_line_ids[0].opening_unit if rec.dg_line_ids else 0
    #             for line in rec.dg_line_ids:
    #                 line.opening_unit = prev_close
    #                 prev_close = line.closing_unit  # or prev_close
    #                 line.closing_unit = prev_close  # Ensures it's never None
...
class GasReading(models.Model):
    ...
    # @api.constrains('gas_line_ids')
    # def _set_opening_units(self):
    #     for rec in self:
    #         if rec.gas_line_ids:
    #             prev_close = rec.gas_line_ids[0].opening_unit if rec.gas_line_ids else 0
    #             for line in rec.gas_line_ids:
    #                 line.opening_unit = prev_close
    #                 prev_close = line.closing_unit  # or prev_close
    #                 line.closing_unit = prev_close
    ...
    def _compute_consumption(self):
        for line in self:
            if line.reset_unit > 1:
                ...
                line.consumption = 0.0
            # if line.closing_unit > line.opening_unit:
            #     line.consumption = (line.closing_unit - line.opening_unit) * (line.reset_unit)
            # elif line.opening_unit > line.closing_unit:
            #     line.consumption = (line.closing_unit * 1000) - line.opening_unit
            # else:
            #     line.consumption = 0.0
...
class WaterReading(models.Model):
    ...
    # @api.constrains('water_line_ids')
    # def _set_opening_units(self):
    #     for rec in self:
    #         if rec.water_line_ids:
    #             prev_close = rec.water_line_ids[0].opening_unit
    #             for line in rec.water_line_ids:
    #                 line.opening_unit = prev_close
    #                 prev_close = line.closing_unit
    #                 line.closing_unit = prev_close
...
class HVACReading(models.Model):
    ...
    # @api.constrains('hvac_line_ids')
    # def _set_opening_units(self):
    #     for rec in self:
    #         if rec.hvac_line_ids:
    #             prev_close = rec.hvac_line_ids[0].opening_unit
    #             for line in rec.hvac_line_ids:
    #                 line.opening_unit = prev_close
    #                 prev_close = line.closing_unit
    #                 line.closing_unit = prev_close
...
class HotWaterReading(models.Model):
    ...
    # @api.constrains('hot_water_line_ids')
    # def _set_opening_units(self):
    #     for rec in self:
    #         if rec.hot_water_line_ids:
    #             prev_close = rec.hot_water_line_ids[0].opening_unit
    #             for line in rec.hot_water_line_ids:
    #                 line.opening_unit = prev_close
    #                 prev_close = line.closing_unit
    #                 line.closing_unit = prev_close
