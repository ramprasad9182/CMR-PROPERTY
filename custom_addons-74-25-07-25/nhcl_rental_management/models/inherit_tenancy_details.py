...
class TenancyDetails(models.Model):
    ...
    def cron_job_invoice_create(self):
        ...
        print(first_day_last_month, last_day_last_month, invoice_year, invoice_month, total_days)
    ...
    #
    #     if self.cam_frequency == 'monthly':
    #         step = relativedelta(months=self.cam_month_date or 1)
    #
    #     elif self.cam_frequency == 'quarterly':
    #         step = timedelta(days=self.cam_quaterly or 90)
    #
    #     elif self.cam_frequency == 'halfyearly':
    #         step = timedelta(days=self.cam_halfday or 180)
    #
    #     elif self.cam_frequency == 'yearly':
    #         step = relativedelta(years=self.cam_ndays or 1)
    #
    #     else:
    #         return
    #
    ...
    #             current_end = current_start + step# - timedelta(days=1)
    #         else:
    #             current_end = current_start + step #- timedelta(days=1)
    #
    #         if current_end > end:
    ...
    #
    #         periods.append((0, 0, {
    #             'cam_start_year': current_start,
    #             'cam_end_date': current_end-timedelta(days=1),
    #             'cam_end_year': current_end,
    #         }))
    #         current_start = current_end # + timedelta(days=1)
    #
    #     self.cam_year_ids = periods
