...
Long description of module's purpose
    ...
    "assets": {
        # Backend assets (for your Food Court dashboard)
        "web.assets_backend": [
        ...
        "point_of_sale._assets_pos": [
            'pos_custom_screen/static/src/app/custom_popup/text_input_popup.js',
            'pos_custom_screen/static/src/app/custom_popup/text_input_popup.xml',
            'pos_custom_screen/static/src/app/custom_button/custom_button.js',
            'pos_custom_screen/static/src/app/custom_button/custom_button.xml',
            "pos_custom_screen/static/src/xml/custom_card_button.xml",
        ],
    },
